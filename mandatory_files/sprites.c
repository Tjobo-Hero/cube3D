...
/*   Updated: 2020/04/08 10:36:22 by vancitters    ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	hit_sprite_y(t_vars *t, t_ray_data *r, int sign1, int sign2)
{
	...
	if (t->sp->pos_wall[t->sp->count] > 1.0 || t->sp->pos_wall[t->sp->count] < 0.0)
